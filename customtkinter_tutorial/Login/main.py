...
app.resizable(0, 0)
PATH_DIR = "customtkinter_tutorial/login/"

side_img_data = Image.open(f"{PATH_DIR}side-img.png")
email_icon_data = Image.open(f"{PATH_DIR}email-icon.png")
password_icon_data = Image.open(f"{PATH_DIR}password-icon.png")
google_icon_data = Image.open(f"{PATH_DIR}google-icon.png")
