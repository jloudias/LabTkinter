...
class View:
    ...
    def create_bottom_frame(self):
        ...
        self.info_label = Label(self.bottom_frame, text="   White to Start the Game  ")
    ...
    def shift(self, start_pos, end_pos):
        ...
        if (
            not piece_at_destination
            or piece_at_destination.color != selected_piece.color
        ):
            try:
    ...
    def draw_single_piece(self, position, piece):
        ...
        if piece:
            filename = "chess/pieces_image/{}_{}.png".format(
            ...
            self.canvas.create_image(
                x0, y0, image=self.images[filename], tags=("occupied"), anchor="c"
            )
    ...
    def on_about_menu_clicked(self):
        messagebox.showinfo(
            "From the Book:", "Tkinter GUI Application\n Development Blueprints"
        )
